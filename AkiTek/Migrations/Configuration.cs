    ...
    internal sealed class Configuration : DbMigrationsConfiguration<AkiTek.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(AkiTek.Models.ApplicationDbContext context)
        {
            ...
            var caracteristicas = new List<Caracteristicas> {
                ...
                new Caracteristicas {ID=2, Nome="Dual SIM", Descricao="Sim"},
                new Caracteristicas {ID=3, Nome="Tipo de SIM", Descricao="Nano SIM"},
                new Caracteristicas {ID=4, Nome="Rede", Descricao="4G LTE"},
            ...
            var produtos = new List<Produtos> {
                new Produtos {ID=1, Nome="Smartphone Huawei Y6 2018", Preco=new Decimal(159.90) ,
                    ...
                    ListaCaracteristicas =new List<Caracteristicas>{ caracteristicas[0], caracteristicas[1],caracteristicas[2], caracteristicas[3],caracteristicas[4], caracteristicas[5], caracteristicas[6],
                        caracteristicas[7], caracteristicas[8],caracteristicas[9], caracteristicas[10],caracteristicas[11], caracteristicas[12], caracteristicas[13], caracteristicas[14], caracteristicas[15],
                        caracteristicas[16], caracteristicas[17] }
                },
                new Produtos {ID=2, Nome="Smartphone Apple iPhone 7 32GB Dourado", Preco=new Decimal(579.00),
                    ...
                    ListaCaracteristicas =new List<Caracteristicas>{ caracteristicas[0], caracteristicas[18],caracteristicas[2], caracteristicas[19],caracteristicas[20], caracteristicas[21], caracteristicas[22],
                        caracteristicas[23], caracteristicas[9],caracteristicas[24], caracteristicas[25],caracteristicas[26], caracteristicas[27], caracteristicas[14], caracteristicas[28], caracteristicas[29],
                        caracteristicas[30], } 
                },
